/*
  Complete Database Schema for DAX Income Tracker
  
  This migration creates all necessary tables, policies, and functions for the application.
  Tables:
  - user_profiles: User information and preferences
  - jobs: Job details and hourly rates
  - work_hours: Time tracking entries
